...
rock.style.boxShadow = '12px 12px 2px 1px rgba(0, 0, 255, .2)';
...
paper.style.boxShadow = '12px 12px 2px 1px rgba(0, 0, 255, .2)';
...
scissors.style.boxShadow = '12px 12px 2px 1px rgba(0, 0, 255, .2)';
